...
trait ManagesLineItems
{
    ...
    protected function handleLineItemAdjustments(DocumentLineItem $lineItem, array $itemData, DocumentDiscountMethod $discountMethod): void
    {
        ...
        // if ($discountMethod->isPerLineItem() && ! isset($itemData[$discountType])) {
        //     logger()->warning('Discount type key missing in item data', ['key' => $discountType]);
        // }
    ...
    {
        // dd($lineItem->calculateDiscountTotal()->getAmount());
