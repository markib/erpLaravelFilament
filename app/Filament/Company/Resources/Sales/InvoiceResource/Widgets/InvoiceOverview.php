...
class InvoiceOverview extends EnhancedStatsOverviewWidget
{
    ...
    // protected static string $view = 'filament.company.resources.sales.invoice-resource.widgets.invoice-overview';
    ...
    protected function getStats(): array
    {
        ...
        $averagePaymentTime = $this->getPageTableQuery()
            ...
            ->selectRaw('(SELECT AVG(EXTRACT(EPOCH FROM (i.paid_at - i.approved_at)) / 86400) FROM invoices AS i WHERE i.paid_at IS NOT NULL) AS avg_days')
            ->value('avg_days');
