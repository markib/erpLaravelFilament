...
<{!! $tag !!}
    ...
    <div class="grid gap-y-2">
        ...
        <div class="flex items-center gap-x-1">
            ...
            <span
                @class([ 'fi-wi-stats-overview-stat-description text-sm' ,
                match ($descriptionColor) { 'gray'=> 'text-gray-500 dark:text-gray-400',
    ...
    <div x-data="{ statsOverviewStatChart: function () {} }">
        <div
            ...
            <span
                ...
                @class([
                match ($chartColor) { 'gray'=> 'text-gray-100 dark:text-gray-800',
            ...
            <span
                ...
                @class([
                match ($chartColor) { 'gray'=> 'text-gray-400',
