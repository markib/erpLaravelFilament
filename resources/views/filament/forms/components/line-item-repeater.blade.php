...
<x-dynamic-component :component="$getFieldWrapperView()" :field="$field">
    <div
        ...
        <div class="table-repeater-container rounded-xl relative ring-1 ring-gray-950/5 dark:ring-white/20">
            <table class="w-full">
                <thead @class([ 'table-repeater-header-hidden sr-only'=> ! $renderHeader,
                    ...
                    <tr class="text-xs md:divide-x md:divide-gray-950/5 dark:md:divide-white/20">
                        ...
                        <th
                            @class([ 'table-repeater-header-column p-2 font-medium first:rounded-tl-xl last:rounded-tr-xl bg-gray-100 dark:text-gray-300 dark:bg-gray-900/60' ,
                ...
                <tbody
                    ...
                    <tr
                        ...
                        @else
                        <td
                            @class([ 'table-repeater-column' , 'p-2'=> ! $streamlined,
